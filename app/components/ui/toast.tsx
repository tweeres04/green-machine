...
const toastVariants = cva(
	'group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border border-orange-200 p-3 pr-4 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-full data-[state=open]:slide-in-from-top-full data-[state=open]:sm:slide-in-from-bottom-full dark:border-orange-800',
	{
		variants: {
			variant: {
				default:
					'border bg-orange-100 text-orange-900 dark:bg-orange-950 dark:text-orange-50',
				destructive:
					'destructive group border-red-500 bg-red-500 text-orange-50 dark:border-red-900 dark:bg-red-900 dark:text-orange-50',
			},
		},
		defaultVariants: {
			variant: 'default',
